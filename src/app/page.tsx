  ...
  return (
    <div className="min-h-dvh bg-sand-100 flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        {/* ログインカード */}
        <div className="bg-white rounded-4xl p-8 shadow-md shadow-gray-200">
          <p className="text-center text-gray-600 text-xl mb-8 leading-relaxed">
            Googleアカウントで
            <br />
            ログインしてください
          </p>
        ...
        <p className="text-center text-sm text-gray-400 mt-8 leading-relaxed">
          ログインすることで
          <a href="#" className="underline underline-offset-2">利用規約</a>と
